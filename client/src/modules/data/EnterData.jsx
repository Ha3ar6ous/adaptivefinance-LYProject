  ...
  return (
    <div>
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <label>
          Hours Worked
          <input type="number" min="0" step="0.1" value={hoursWorked} onChange={(e) => setHoursWorked(e.target.value)} required />
        </label>
        <label>
          Orders Completed
          <input type="number" min="0" value={ordersCompleted} onChange={(e) => setOrdersCompleted(e.target.value)} required />
        </label>
        <label>
          Income
          <input type="number" min="0" step="0.01" value={income} onChange={(e) => setIncome(e.target.value)} required />
        </label>
